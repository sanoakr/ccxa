...
| LLM | [Ternary Bonsai 8B 1.58bit](https://huggingface.co/prism-ml/Ternary-Bonsai-8B-mlx-2bit) ([mlx_lm.server](https://github.com/ml-explore/mlx-lm) + [OpenAI API](https://github.com/openai/openai-python)) |
